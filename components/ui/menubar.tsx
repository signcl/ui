...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Portal>
    <MenubarPrimitive.SubContent
      ref={ref}
      className={cn(
        'z-50 min-w-[8rem] overflow-hidden rounded-md border floating px-0 py-1',
...
>(({ className, align = 'start', alignOffset = -4, sideOffset = 8, ...props }, ref) => (
  <MenubarPrimitive.Portal>
    <MenubarPrimitive.Content
      ...
      className={cn(
        'z-50 min-w-[12rem] overflow-hidden rounded-md border floating px-0 py-1',
...
>(({ className, children, checked, ...props }, ref) => (
  <MenubarPrimitive.CheckboxItem
    ref={ref}
    className={cn(
      'relative flex cursor-default select-none items-center py-1.5 pl-7 pr-2 text-sm outline-none',
      'focus:bg-ac/10 focus:text-ac data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
      className
    )}
    checked={checked}
...
>(({ className, inset, ...props }, ref) => (
  <MenubarPrimitive.Label
    ref={ref}
    className={cn('text-fg/60 px-2 py-1.5 text-xs leading-none uppercase', inset && 'pl-7', className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <MenubarPrimitive.Separator ref={ref} className={cn('bg-fg/5 -mx-1 h-1', className)} {...props} />
))

...
const buttonVariantsConfig = {
  size: {
    sm: 'text-xs rounded-sm h-6 gap-1.5 px-2 has-[>svg]:px-1.5',
    default: 'text-base rounded-md h-8 px-3 py-2 has-[>svg]:px-2',
    lg: 'text-lg rounded-md h-10 px-4 has-[>svg]:px-3',
  ...
  variant: {
    ...
    ghost:
      'border border-transparent focus-visible:border-transparent text-fg not-disabled:hover:text-ac bg-transparent',
...
const buttonVariants = cva(
  'appearance-none inline-flex items-center gap-1 cursor-pointer justify-center whitespace-nowrap font-medium focus-ring disabled:cursor-not-allowed disabled:opacity-50',
  {
    ...
    compoundVariants: [
      ...
      // Ghost
      { variant: 'ghost', tint: 'default', className: 'not-disabled:hover:text-ac data-[state=open]:text-ac' },

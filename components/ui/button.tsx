...
const buttonVariantsConfig = {
  ...
  variant: {
    ...
    link: 'border border-transparent text-fg not-disabled:hover:text-ac bg-transparent',
  },
  tint: {
...
const buttonVariants = cva(
  'appearance-none inline-flex items-center gap-1 cursor-pointer justify-center whitespace-nowrap rounded-md font-medium focus-ring disabled:cursor-not-allowed disabled:opacity-50',
  {
    ...
    compoundVariants: [
      ...
      { variant: 'solid', tint: 'gray', className: 'bg-gray-600 border-gray-600 text-bg not-disabled:hover:bg-gray-700' },
      { variant: 'solid', tint: 'red', className: 'bg-red-600 border-red-600 text-bg not-disabled:hover:bg-red-700' },
      { variant: 'solid', tint: 'orange', className: 'bg-orange-600 border-orange-600 text-bg not-disabled:hover:bg-orange-700' },
      { variant: 'solid', tint: 'amber', className: 'bg-amber-600 border-amber-600 text-bg not-disabled:hover:bg-amber-700' },
      { variant: 'solid', tint: 'yellow', className: 'bg-yellow-600 border-yellow-600 text-bg not-disabled:hover:bg-yellow-700' },
      { variant: 'solid', tint: 'lime', className: 'bg-lime-600 border-lime-600 text-bg not-disabled:hover:bg-lime-700' },
      { variant: 'solid', tint: 'green', className: 'bg-green-600 border-green-600 text-bg not-disabled:hover:bg-green-700' },
      { variant: 'solid', tint: 'emerald', className: 'bg-emerald-600 border-emerald-600 text-bg not-disabled:hover:bg-emerald-700', },
      { variant: 'solid', tint: 'teal', className: 'bg-teal-600 border-teal-600 text-bg not-disabled:hover:bg-teal-700' },
      { variant: 'solid', tint: 'cyan', className: 'bg-cyan-600 border-cyan-600 text-bg not-disabled:hover:bg-cyan-700' },
      { variant: 'solid', tint: 'sky', className: 'bg-sky-600 border-sky-600 text-bg not-disabled:hover:bg-sky-700' },
      { variant: 'solid', tint: 'blue', className: 'bg-blue-600 border-blue-600 text-bg not-disabled:hover:bg-blue-700' },
      { variant: 'solid', tint: 'indigo', className: 'bg-indigo-600 border-indigo-600 text-bg not-disabled:hover:bg-indigo-700' },
      { variant: 'solid', tint: 'violet', className: 'bg-violet-600 border-violet-600 text-bg not-disabled:hover:bg-violet-700' },
      { variant: 'solid', tint: 'purple', className: 'bg-purple-600 border-purple-600 text-bg not-disabled:hover:bg-purple-700' },

  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        className={cn(
          'floating fixed top-[50%] left-[50%] grid max-h-[calc(100dvh-10px)] w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-3 overflow-y-auto border p-4 duration-200 sm:rounded-lg',

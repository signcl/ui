...
const inputVariants = cva(
  [
    'border-input flex w-full appearance-none rounded-sm border border-fg/30 bg-transparent',
    'text-fg shadow-inset-shadow outline-hidden file:border-0 file:bg-transparent file:font-medium file:text-fg placeholder:text-fg/40',
